...
class XBertLMHeadDecoder(BertLMHeadModel):
    ...
    def from_config(cls, cfg, from_pretrained=False):
        ...
        if from_pretrained:
            return cls.from_pretrained("/ihoment/wuyingdong/work_tool/dataAPP/bert", config=med_config)
        else:
    ...
    def from_config(cls, cfg, from_pretrained=False):
        ...
        if from_pretrained:
            return cls.from_pretrained(
                "/ihoment/wuyingdong/work_tool/dataAPP/bert", config=med_config, add_pooling_layer=False
            )
        else:
